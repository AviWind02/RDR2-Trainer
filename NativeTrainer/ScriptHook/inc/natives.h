...
namespace CURSOR
{
	...
	static Any _IS_LEFT_MOUSE_BUTTON_HELD() { return invoke<Any>(0x61CAE9D1FD055E44); }
	static Any _IS_LEFT_MOUSE_BUTTON_RELEASED() { return invoke<Any>(0xF7F51A57349739F2); }
}
